...
public final class Installed {
	...
	public static final String PLATFORM_NAME = "SVN log Analysis Platform";
	public static final String APPHOME_KEY = "SVNLOG_HOME";
	...
	public static void startup() {
		// TODO 每次服务启动都会执行
		List<Map<String, Object>> list = jdbcTemplate.queryForList("select tbl_name from sqlite_master");
		Utility.println(JSON.toJSONString(list));
	}
